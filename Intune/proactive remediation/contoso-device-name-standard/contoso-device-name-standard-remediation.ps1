...
$LogoImageUri = "https://csi0101.blob.core.windows.net/img/hommer3.gif"
$HeroImageUri = "https://csi0101.blob.core.windows.net/img/hommer1.gif"
...
$AttributionText = "### ALERT ! ###"
$HeaderText = "Please rename your device!"
$TitleText = "Your device is not in compliance with Naming Standards"
$BodyText1 = "Make sure Device name is renamed."
$BodyText2 = "Please contact Local IT. Thank you in advance."
